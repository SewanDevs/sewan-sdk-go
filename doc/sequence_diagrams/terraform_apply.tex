...
\begin{center}
  \begin{tikzpicture}
    ...
    \umlobject[class=TfstateTAT, x=0.5]{localstate}
	...
	\begin{umlfragment}[type=alt, label=resource\_not\_exists, name=else, inner xsep=18,fill=white]
